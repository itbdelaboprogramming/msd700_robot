#ifndef _ROS_msd700_msg_HardwareCommand_h
#define _ROS_msd700_msg_HardwareCommand_h
...
namespace msd700_msg
{
  ...
  class HardwareCommand : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "msd700_msg/HardwareCommand"; };
